# jpeg-compressor
Note: The latest version of jpgd.cpp/.h is currently in the [Basis Universal](https://github.com/BinomialLLC/basis_universal) repo. It's been fuzz tested, chroma subsampling has been added, and cleaned up.
...
As an added bonus, the source distribution now also includes an optional, completely stand-alone public domain JPEG decompression class with progressive image support in a single source file [jpgd.cpp](https://github.com/orian/jpeg-compressor/blob/master/jpgd.cpp).
